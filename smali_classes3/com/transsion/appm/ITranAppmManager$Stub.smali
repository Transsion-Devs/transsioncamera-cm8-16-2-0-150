...
.method public static asInterface(Landroid/os/IBinder;)Lcom/transsion/appm/ITranAppmManager;
    ...
    .line 51
    check-cast v0, Lcom/transsion/appm/ITranAppmManager;

    return-object v0

    .line 53
    :cond_13
    new-instance v0, Lcom/transsion/appm/ITranAppmManager$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/transsion/appm/ITranAppmManager$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
