.class public Lcom/transsion/camera/feature/setting/videoasd/VideoAsdRestriction;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/transsion/camera/feature/setting/videoasd/VideoAsdRestriction;->sRelationGroup:Lcom/transsion/camera/app/common/relation/RelationGroup;
    ...
    .line 30
    sget-object v0, Lcom/transsion/camera/feature/setting/videoasd/VideoAsdRestriction;->sRelationGroup:Lcom/transsion/camera/app/common/relation/RelationGroup;

    const-string v2, "key_video_portrait,key_video_facebeauty,key_video_slimbody_info,key_video_slimbody_face_beauty,key_video_multi_face_beauty,key_video_quality,key_video_makeup,key_video_super_night,key_algorithm_migrate,key_transsion_filter,key_anti_video,key_night_hawk,key_com_video_hdr,key_video_filter,key_video_effect,key_video_frame,key_video_spot,key_super_anti_video"
    ...
    const-string/jumbo v5, "video_facebeauty_off,video_facebeauty_on"

    .line 37
    const-string v7, "key_video_facebeauty"

    invoke-virtual {v2, v7, v4, v5}, Lcom/transsion/camera/app/common/relation/Relation$Builder;->addBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/transsion/camera/app/common/relation/Relation$Builder;
    ...
    const-string v7, "key_video_quality"
    ...
    const-string v8, "key_anti_video"

    const-string v9, "off,on,ai"

    .line 46
    invoke-virtual {v2, v8, v6, v9}, Lcom/transsion/camera/app/common/relation/Relation$Builder;->addBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/transsion/camera/app/common/relation/Relation$Builder;

    move-result-object v2

    .line 47
    const-string v8, "key_night_hawk"

    invoke-virtual {v2, v8, v6, v5}, Lcom/transsion/camera/app/common/relation/Relation$Builder;->addBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/transsion/camera/app/common/relation/Relation$Builder;
    ...
    const-string v11, "key_video_filter"

    const-string v12, "filter_default"

    .line 49
    invoke-virtual {v2, v11, v12, v10}, Lcom/transsion/camera/app/common/relation/Relation$Builder;->addBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/transsion/camera/app/common/relation/Relation$Builder;

    move-result-object v2

    const-string v11, "key_video_effect"

    const-string v12, "effect_default"
    ...
    const-string v11, "key_video_frame"
    ...
    .line 52
    invoke-virtual {v2, v10, v6, v5}, Lcom/transsion/camera/app/common/relation/Relation$Builder;->addBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/transsion/camera/app/common/relation/Relation$Builder;

    move-result-object v2

    const-string v10, "key_super_anti_video"

    const-string v11, "on,ai,super,off"

    .line 53
    invoke-virtual {v2, v10, v6, v11}, Lcom/transsion/camera/app/common/relation/Relation$Builder;->addBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/transsion/camera/app/common/relation/Relation$Builder;
    ...
    .line 59
    invoke-virtual {v1, v8, v3, v5}, Lcom/transsion/camera/app/common/relation/Relation$Builder;->addBody(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/transsion/camera/app/common/relation/Relation$Builder;
