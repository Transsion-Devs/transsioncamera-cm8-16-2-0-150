...
.method private static createNewNativeDirAboveEqualApiLevel21(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :try_end_9c
    .catch Ljava/lang/IllegalArgumentException; {:try_start_77 .. :try_end_9c} :catch_a7
    .catch Ljava/lang/InstantiationException; {:try_start_77 .. :try_end_9c} :catch_a2
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_77 .. :try_end_9c} :catch_9d
...
.method public static init(Landroid/content/Context;Ljava/lang/String;I)Lcom/meicam/effect/sdk/NvsEffectSdkContext;
    ...
    :try_end_83
    .catch Ljava/lang/Exception; {:try_start_5b .. :try_end_83} :catch_7d

    .line 268
    :try_start_83
    sget v2, Lcom/meicam/sdk/NvsStreamingContext;->STREAMING_CONTEXT_FLAG_SUPPORT_4K_EDIT:I
    :try_end_85
    .catch Ljava/lang/Exception; {:try_start_83 .. :try_end_85} :catch_87
    ...
    throw p0
    :try_end_ee
    .catch Ljava/lang/Exception; {:try_start_88 .. :try_end_ee} :catch_7d
...
.method private static tryLoadFaceDetectionLibrary()V
    ...
    :cond_19
    :try_start_19
    const-string v0, "com.meicam.effect.sdk.NvsMGFaceEffectDetector"
    ...
    :catch_1f
    :try_start_1f
    const-string v0, "com.meicam.sdk.NvsMGFaceEffectDetector"

    invoke-static {v0}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;
    :try_end_24
    .catch Ljava/lang/Exception; {:try_start_1f .. :try_end_24} :catch_35

    .line 798
    :goto_24
    const-string v0, "megface-new"
    ...
    invoke-static {v0}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;
    :try_end_40
    .catch Ljava/lang/Exception; {:try_start_3b .. :try_end_40} :catch_49
    ...
    invoke-static {v0}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;
    :try_end_54
    .catch Ljava/lang/Exception; {:try_start_4f .. :try_end_54} :catch_66
