...
.method public _deserializeUsingProperties(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/DeserializationContext;)Ljava/util/EnumMap;
    ...
    move-result-object v3
    :try_end_a3
    .catch Ljava/lang/Exception; {:try_start_80 .. :try_end_a3} :catch_90
    ...
    :try_end_bc
    .catch Ljava/lang/Exception; {:try_start_b6 .. :try_end_bc} :catch_bd
...
.method protected constructMap(Lcom/fasterxml/jackson/databind/DeserializationContext;)Ljava/util/EnumMap;
    ...
    :try_end_1f
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_1f} :catch_2b
    ...
    invoke-virtual {p0, v1}, Lcom/fasterxml/jackson/databind/deser/ValueInstantiator;->createUsingDefault(Lcom/fasterxml/jackson/databind/DeserializationContext;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Ljava/util/EnumMap;
    :try_end_37
    .catch Ljava/io/IOException; {:try_start_21 .. :try_end_37} :catch_28

    return-object p0

    .line 349
    :goto_38
    invoke-static {v1, p0}, Lcom/fasterxml/jackson/databind/util/ClassUtil;->throwAsMappingException(Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/io/IOException;)Ljava/lang/Object;
...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/DeserializationContext;Ljava/util/EnumMap;)Ljava/util/EnumMap;
    ...
    move-result-object v2
    :try_end_78
    .catch Ljava/lang/Exception; {:try_start_5b .. :try_end_78} :catch_6b
