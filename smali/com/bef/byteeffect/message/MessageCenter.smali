.class public Lcom/bef/byteeffect/message/MessageCenter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/bef/byteeffect/message/MessageCenter$MessageHandler;,
        Lcom/bef/byteeffect/message/MessageCenter$Listener;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bef/byteeffect/message/MessageCenter;->sMessageCenterThreadLock:Ljava/lang/Object;
    ...
    sput-object v0, Lcom/bef/byteeffect/message/MessageCenter;->sListeners:Ljava/util/List;
...
.method static synthetic access$000(Landroid/os/Message;)V
    ...
    .line 12
    invoke-static {p0}, Lcom/bef/byteeffect/message/MessageCenter;->handleMessage(Landroid/os/Message;)V

    return-void
.end method

.method public static addListener(Lcom/bef/byteeffect/message/MessageCenter$Listener;)V
    .registers 3

    .line 134
    sget-object v0, Lcom/bef/byteeffect/message/MessageCenter;->sListeners:Ljava/util/List;
...
.method public static destroy()V
    ...
    .line 177
    :cond_d
    sget-object v1, Lcom/bef/byteeffect/message/MessageCenter;->sMessageCenterThreadLock:Ljava/lang/Object;
    ...
    .line 178
    :try_start_10
    sget-object v2, Lcom/bef/byteeffect/message/MessageCenter;->sMessageHandler:Landroid/os/Handler;
    ...
    .line 180
    sput-object v3, Lcom/bef/byteeffect/message/MessageCenter;->sMessageHandler:Landroid/os/Handler;
    ...
    :cond_1d
    :goto_1d
    sget-object v2, Lcom/bef/byteeffect/message/MessageCenter;->sMessageCenterThread:Landroid/os/HandlerThread;
    ...
    .line 185
    sput-object v3, Lcom/bef/byteeffect/message/MessageCenter;->sMessageCenterThread:Landroid/os/HandlerThread;

    .line 187
    :cond_26
    monitor-exit v1
    :try_end_27
    .catchall {:try_start_10 .. :try_end_27} :catchall_1b
    ...
    monitor-exit v0
    :try_end_2b
    .catchall {:try_start_27 .. :try_end_2b} :catchall_b
    ...
    monitor-exit v0
    :try_end_2f
    .catchall {:try_start_2d .. :try_end_2f} :catchall_b
...
.method private static handleMessage(Landroid/os/Message;)V
    ...
    check-cast v2, Lcom/bef/byteeffect/message/MessageCenter$Listener;
    ...
    invoke-interface {v2, v3, v4, v5, v6}, Lcom/bef/byteeffect/message/MessageCenter$Listener;->onMessageReceived(IIILjava/lang/String;)V
...
.method public static init()V
    ...
    .line 161
    sget-object v0, Lcom/bef/byteeffect/message/MessageCenter;->sMessageCenterThreadLock:Ljava/lang/Object;

    monitor-enter v0

    .line 162
    :try_start_3
    sget-object v1, Lcom/bef/byteeffect/message/MessageCenter;->sMessageCenterThread:Landroid/os/HandlerThread;
    ...
    sput-object v1, Lcom/bef/byteeffect/message/MessageCenter;->sMessageCenterThread:Landroid/os/HandlerThread;

    .line 164
    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    .line 166
    new-instance v1, Lcom/bef/byteeffect/message/MessageCenter$MessageHandler;
    ...
    invoke-direct {v1, v2}, Lcom/bef/byteeffect/message/MessageCenter$MessageHandler;-><init>(Landroid/os/Looper;)V

    sput-object v1, Lcom/bef/byteeffect/message/MessageCenter;->sMessageHandler:Landroid/os/Handler;
    ...
    monitor-exit v0
    :try_end_34
    .catchall {:try_start_3 .. :try_end_34} :catchall_16
...
.method private static postMessage(IIILjava/lang/String;)V
    ...
    .line 196
    :try_start_3
    sget-object v1, Lcom/bef/byteeffect/message/MessageCenter;->sMessageHandler:Landroid/os/Handler;
...
.method public static removeListener(Lcom/bef/byteeffect/message/MessageCenter$Listener;)V
    .registers 2
...
.method public static setListener(Lcom/bef/byteeffect/message/MessageCenter$Listener;)V
    .registers 2
    ...
    .line 129
    :try_start_3
    invoke-static {p0}, Lcom/bef/byteeffect/message/MessageCenter;->addListener(Lcom/bef/byteeffect/message/MessageCenter$Listener;)V
